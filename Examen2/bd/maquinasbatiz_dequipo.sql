...
CREATE TABLE `dequipo` (
  `etiqueta_id` varchar(15) NOT NULL,
  `serial_id` varchar(15) NOT NULL,
  `teclado_id` varchar(15) NOT NULL,
  `mouse_id` varchar(15) NOT NULL,
  `marca_id` varchar(15) NOT NULL,
  `monitor_id` varchar(15) NOT NULL,
  `edoquipo_id` varchar(15) NOT NULL,
  `lab_id` varchar(15) NOT NULL,
  `config_id` varchar(15) NOT NULL,
  `problema` varchar(35) NOT NULL,
...
-- Dump completed on 2022-04-21 15:26:34
